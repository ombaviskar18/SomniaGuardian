        ...
        <div className="workflow-container">
          ...
          >
            <h2 className="workflow-title">
              How SomniaGuardian Works
            </h2>
            <p className="workflow-subtitle">
              Four-stage analysis powered by Somnia's Universal Smart Contracts and AI intelligence
            </p>
          </motion.div>
        ...
        <div className="footer-container">
          <div className="footer-content">
            ...
            <div className="footer-brand">
              <div className="footer-logo">
                <img src="/logos/logo.png" alt="SomniaGuardian Logo" className="footer-logo-img" />
                <span className="footer-logo-text">SomniaGuardian</span>
              </div>
            ...
            <div className="footer-links">
              ...
              <div className="footer-column">
                ...
                <ul className="footer-link-list">
                  <li><a href="#" className="footer-link">SomniaGuardian AI</a></li>
          ...
          <div className="footer-bottom">
            <div className="footer-bottom-left">
              <p className="footer-copyright">© 2025 Copyright SomniaGuardian INC. Powered by Somnia. Built with ❤️ for DeFi security.</p>
            ...
            <div className="footer-bottom-right">
              <div className="footer-social">
                <a 
                  href="https://github.com/ombaviskar18/SomniaGuardian" 
                  target="_blank" 
